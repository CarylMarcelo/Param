  ...
  <div class="profile-card">
    ...
    <div class="profile-sidebar">
      ...
      <div class="user-summary">
        <?php
        $imagePath = (!empty($profilePic)) ? $profilePic : 'path/to/default-avatar.png';
        ?>
        <img src="<?php echo $imagePath; ?>" alt="Profile Picture" class="user-avatar" id="avatarPreview">
